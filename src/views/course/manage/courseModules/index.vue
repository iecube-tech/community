            ...
            <template #header>
                <div class="card-header">
                    <span>
                        ...
                        <el-divider v-if="routeName != 'courseAdd'" direction="vertical" />
                        <span v-if="routeName != 'courseAdd'">{{ content.name }}</span>
                        <el-divider v-if="route.name != 'courseModulesList'" direction="vertical" />
                        <span v-if="route.name != 'courseModulesList'">{{ route.meta.title }}</span>
                    </span>
                    <div>
                        <el-button v-if="routeName == 'coursePoints'" type="primary" link>知识模块管理</el-button>
                        <el-divider v-if="routeName == 'coursePoints'" direction="vertical" />
