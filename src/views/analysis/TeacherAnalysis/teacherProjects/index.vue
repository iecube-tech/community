<template>
    ...
    <div class="contents">
        <div v-for="  project   in   projects  " :key="project.id" class="content">
...
import { teacherProject } from "@/apis/project/teacherproject.js";
